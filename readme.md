...
1. **Region War**:  
   ...
   \----  
   Related Files:  
   * [01_AllWarNeighbor.json](./01_AllWarNeighbor.json) - Generated from `01_Parser.js`
   * [01_AllWarNeighborNoSelf.json](./01_AllWarNeighborNoSelf.json) - Generated from `01_AllWarNeighbor.json`
   * [01_AllWarNeighbor.json.zip](01_AllWarNeighbor.json.zip)
   * [01_AllWarNeighborNoSelf.json.zip](01_AllWarNeighborNoSelf.json.zip)
